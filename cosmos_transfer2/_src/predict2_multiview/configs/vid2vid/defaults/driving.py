...
# Configuration for autoregressive generation - loads longer sequences

MADS_DRIVING_DATALOADER_CONFIG_res720_AUTOREGRESSIVE = copy.deepcopy(MADS_DRIVING_DATALOADER_CONFIG_res720)
MADS_DRIVING_DATALOADER_CONFIG_res720_AUTOREGRESSIVE.num_video_frames_loaded_per_view = 85  # 56 * 3 + 1
MADS_DRIVING_DATALOADER_CONFIG_res720_AUTOREGRESSIVE.num_video_frames_per_view = 85  # Output all loaded frames
MADS_DRIVING_DATALOADER_CONFIG_res720_AUTOREGRESSIVE.minimum_start_index = 0
...
MADS_DRIVING_DATALOADER_CONFIG_PER_RESOLUTION = {
    ...
    "720_autoregressive": MADS_DRIVING_DATALOADER_CONFIG_res720_AUTOREGRESSIVE,
}
